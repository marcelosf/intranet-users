...
class UserManager(BaseUserManager):
    ...
    def _update_or_create_user(self, login, name, user_type, main_email,
        ...
        main_email = self.normalize_email(main_email)
        user_data = dict(name=name, type=type, main_email=main_email,
    ...
    def create_user(self, login, name, type, main_email=None,
                    password=None, **extra_fields):

        return self._create_user(login, name, type, main_email,
                                 password, False, False, **extra_fields)

    def update_or_create_user(self, login, name, type, main_email=None,
                              password=None, **extra_fields):
        return self._update_or_create_user(login, name, type, main_email,
                                           password, False, False,
                                           **extra_fields)

    def create_superuser(self, login, name, type, main_email,
                         password, **extra_fields):

        user = self._create_user(login, name, type, main_email, password, True,
                                 True, **extra_fields)
        user.is_active = True
